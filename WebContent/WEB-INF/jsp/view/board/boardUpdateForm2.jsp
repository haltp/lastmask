					          ...
					          <form id="frm" name="frm" action="boardUpdate.do?row=${vo.boardNumber }" method="post">
								...
								<input type="hidden" name="boardValue2" value="${vo.boardValue }">
								 ...
								 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									<tr>
										<th>게시글 번호</th>
										<td><input style="border:none" type="text" name="boardNumber" size="50" value="${vo.boardNumber }" readonly /></td>
									</tr>
									<tr>
										<th>작성자</th>
										<td><input style="border:none" type="text" name="boardWriter" size="50" value="${vo.boardWriter }" readonly /></td>
									</tr>
									<tr>
										<th>제목</th>
									...
									<tr>
										<th>작성일</th>
										<td><input style="border:none" type="text" name="boardDate" size="50" value="${vo.boardDate }" readonly /></td>
									</tr>
									<tr>
										<th>조회수</th>
