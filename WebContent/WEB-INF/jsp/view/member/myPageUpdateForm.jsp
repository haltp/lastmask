		...
		<c:forEach var="vo" items="${list }">
			<form id="frm" name="frm"
					...
					<div class="control-group">
						<div class="form-group floating-label-form-group controls">
							<label>Id</label> <input class="form-control" id="memberId"
								name="memberId" type="text" value="${vo.memberId }"
								readonly="readonly" />
					...
					<div class="control-group">
						<div class="form-group floating-label-form-group controls ">
							<label>Name</label> <input class="form-control" id="memberName"
								name="memberName" type="text" value="${vo.memberName }"
								required="required" />
							<p class="help-block text-danger"></p>
						</div>
					</div>
					<div class="control-group">
						<div class="form-group floating-label-form-group controls ">
							<label>Password</label> <input class="form-control"
								...
								value="${vo.memberPassword }" required="required" />
							<p class="help-block text-danger"></p>
						</div>
					</div>
					<div class="control-group">
						<div class="form-group floating-label-form-group controls ">
							<label>Password Check</label> <input class="form-control"
								id="memberPassword1" name="memberPassword1" type="password"
								value="${vo.memberPassword }" required="required" />
							<p class="help-block text-danger"></p>
						</div>
					</div>
					<div class="control-group">
						<div class="form-group floating-label-form-group controls ">
							<label>Phone Number</label> <input class="form-control"
								...
								value="${vo.memberPhone }" required="required" />
							<p class="help-block text-danger"></p>
						</div>
					</div>
					<div class="control-group">
						<div class="form-group floating-label-form-group controls ">
							<label>우편번호</label> <input class="form-control"
								id="memberZipcode" name="memberZipcode" type="text" onclick="openZipSearch()"
								value="${vo.memberZipcode }" required="required" />
							<p class="help-block text-danger"></p>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						<div class="form-group floating-label-form-group controls ">
							<label>Mail</label> <input class="form-control" id="memberEmail"
								name="memberEmail" type="text" value="${vo.memberEmail }"
								required="required" />
							<p class="help-block text-danger"></p>
						</div>
					</div>
					<div class="control-group">
						<div class="form-group floating-label-form-group controls ">
							<label>Auth</label> <input class="form-control" id="memberAuth"
								name="memberAuth" type="text" value="${vo.memberAuth }"
								readonly="readonly" />
							<p class="help-block text-danger"></p>
						</div>
					</div>
				...
				<div class="text-center mt-4">
					<button class="btn btn-xl btn-outline-light" type="submit">수정완료</button>
					&nbsp;
					<button class="btn btn-xl btn-outline-light" type="reset">취소</button>
					&nbsp;
					<button class="btn btn-xl btn-outline-light" type="button" onclick="location.href='myPageForm.do'">마이페이지</button>
				</div>
			</form>
		</c:forEach>
		<!--  </div> -->
