...
@WebServlet("/GetBoardListTest2")
public class GetBoardListTest2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public GetBoardListTest2() {
        super();
...
//			json += "\""+prd.getBoardNumber()+"\"";
//			json += ",\""+ prd.getBoardTitle()+"\"";
//			json += ",\""+ prd.getBoardWriter()+"\"";
//			json += ",\""+ prd.getBoardDate()+"\"";
//			json += ",\""+ prd.getBoardHit()+"\"";		
			json += "}";
